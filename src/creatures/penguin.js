...
//     それがずんぐりした鳥の見え方そのもの
const DORSAL  = [0.26, 0.77, 0.66, 0.82, 0.84, 0.84, 0.82, 0.80, 0.75, 0.60, 0.33];
const VENTRAL = [-0.13, -0.43, -0.53, -1.00, -1.14, -1.14, -1.10, -1.04, -0.90, -0.60, -0.22];
...
const W_PROFILE = [0.185, 0.575, 0.55, 0.85, 1.00, 1.00, 0.98, 0.94, 0.86, 0.64, 0.26];
 ...
 */
// 羽毛を含めた外形の見かけ密度。休んでいるペンギンが水に浮くとき
// 3割ほどが水面から出ているので、それくらい。陸で寒いときはさらに
// 羽毛を立てるので、立ち姿の輪郭はもう少し嵩がある
const PLUMAGE_DENSITY = 0.68;
// 断面の縦横比(深さ/幅)。ペンギンの胴はわずかに背腹へ高いが、
// 竜骨突起の張った胸は横にも広い。1.2を超えると正面から見て板になる
const BODY_ASPECT = 1.18;
